...
elseif($job=='addsp')
{
	if($step==2){
		...
		$sql = "INSERT INTO `{$pre}special` ( `fid` , `title` ,  `style` , `template` , `picurl` , `content`  ,`uid` , `username` , `posttime` , `list`, `allowpost`, `yz`, `banner` ) VALUES ('$postdb[fid]','$postdb[title]','$style','','$postdb[picurl]','$postdb[content]','$lfjuid','$lfjid','$timestamp','$timestamp','$postdb[allowpost]','$yz','$postdb[banner]')";
		$db->query($sql);
